...
class NotificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupClickListeners()
        setupSidebarMenu()
        loadNotificationsFromFirebase() // Changed from loadSampleNotifications()
    }
            ...
            .setPositiveButton("Delete") { _, _ ->
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    ...
                    if (success) {
                        ...
                        Toast.makeText(this@NotificationActivity, "Failed to delete notification", Toast.LENGTH_SHORT).show()
                    }
                }
            }
